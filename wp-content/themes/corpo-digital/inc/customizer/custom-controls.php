 ...
 */
class  Corpo_Digital_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class  Corpo_Digital_Dropdown_Category_Control extends WP_Customize_Control {
...
class  Corpo_Digital_Note_Control extends WP_Customize_Control {
...
class  Corpo_Digital_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  Corpo_Digital_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corpo-digital-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class  Corpo_Digital_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corpo-digital-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class  Corpo_Digital_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class  Corpo_Digital_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class  Corpo_Digital_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class  Corpo_Digital_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="corpo-digital-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'corpo-digital' ); ?>" class="corpo-digital-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}