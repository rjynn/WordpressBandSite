...
class  Corpo_Digital_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corpo_digital';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corpo-digital' ), $i ),
...
// Initialize.
$corpo_digital_footer_widgets = new  Corpo_Digital_Footer_Widgets();
